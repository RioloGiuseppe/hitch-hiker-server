...
Public Class AccountController
    ...
    Public Function Register(ByVal model As RegisterModel) As ActionResult
        If ModelState.IsValid Then
            ...
            Try
                WebSecurity.CreateUserAndAccount(model.UserName, model.Password, New With {.Name = model.Name,
                                                                                           .Surname = model.Surname})
                Roles.AddUserToRole(model.UserName, model.Kind)
    ...
    Public Function ExternalLoginConfirmation(ByVal model As RegisterExternalLoginModel, ByVal returnUrl As String) As ActionResult
        ...
        If ModelState.IsValid Then
            ...
            Using db As New UsersContext()
                Dim user = db.Users.FirstOrDefault(Function(u) u.UserName.ToLower() = model.UserName.ToLower())
                ' Verifica se l'utente esiste già
                If user Is Nothing Then
                    ' Inserire il nome nella tabella dei profili
                    db.Users.Add(New User With {.UserName = model.UserName})
                    db.SaveChanges()
